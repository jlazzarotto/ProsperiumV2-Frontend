...
export const MODULOS: ModuloDefinition[] = [
  ...
  { key: 'admin.importacao_dados', label: 'Porto Sem Papel (PSP)', category: 'admin', categoryLabel: 'Administrador' },
  ...
  { key: 'cadastros.contas_financeiras', label: 'Contas Financeiras', category: 'cadastros', categoryLabel: 'Cadastros' },
...
const ROUTE_MODULO_RULES: Array<{ path: string; modulo: string; exact?: boolean }> = [
  ...
  { path: '/cadastros/contas-financeiras', modulo: 'cadastros.contas_financeiras', exact: true },
  { path: '/cadastros/contas-caixa', modulo: 'cadastros.contas_financeiras', exact: true },
